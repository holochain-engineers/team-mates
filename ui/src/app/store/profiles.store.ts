...
import { Person, Profile } from '../models/person';
...
export interface ProfileListState {
  profiles: Dictionary<Profile> | undefined;
  editedProfile: Profile | undefined;
}

const defaultState: ProfileListState = {
  profiles: undefined,
...
export class ProfilesStore
  extends ComponentStore<ProfileListState>
