...
export const mock1AgentProfile:AgentProfile = {agent_pub_key: "12C0kP3Cu8QRxERdKJZIqlI3y_gQuJke5qFp7Ae52L49N-ds", profile: mock1Profile};

export const mock2Profile:Profile = {nickname: "friend2",fields:{["avatar"]:"loop"}}

export const mock2AgentProfile:AgentProfile = {agent_pub_key: "12C0kP3Cu8QRxERdKJZIqlI3y_gQuJke5qFp7Ae52L49N-es", profile: mock2Profile};
